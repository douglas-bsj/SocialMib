      ...
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
          ...
          <p className="mt-4 text-center text-xs text-gray-400">
            ...
            <Link href="/terms" className="text-violet-600 hover:underline">Termos de Serviço</Link>{" "}
            e a{" "}
            <Link href="/privacy" className="text-violet-600 hover:underline">Política de Privacidade</Link>
          </p>
        </div>
